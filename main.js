(() => {
  ...
  let currentScene = 0;
  let enterNewScene = false; //새로운 씬이 시작된순간 true
  let acc = 0.1;
  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      objs: {
        ...
        imagesPath: ["./images/ryan.jpg", "./images/blend-image-2.jpg"],
        images: [],
      },
      values: {
  ...
  function setCanvasImages() {
    ...
    for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
      ...
      imgElem.src = `./video/1/ryon_${1 + i}.jpg`;
      sceneInfo[0].objs.videoImages.push(imgElem);
    }
    let imgElem2;
    for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
      imgElem2 = document.createElement("img");
      imgElem2.src = `./video/2/ryon_${301 + i}.jpg`;
  ...
  function setLayout() {
    ...
    const heightRatio = window.innerHeight / 1088;
      ...
      case 2:
        ...
        if (scrollRatio > 0.9) {
          ...
          if (widthRatio <= heightRatio) {
            ...
            // canvas보다 브라우저 창이 납작한 경우
            canvasScaleRatio = widthRatio;
          }

          objs.canvas.style.transform = `scale(${canvasScaleRatio})`;
          objs.context.fillStyle = "rgb(233, 232, 230)";
          objs.context.drawImage(objs.images[0], 0, 0);

          // 캔버스사이즈에 맞춰 가정한 innerwidth와 innerHeight
      ...
      case 3:
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          if (
            ...
            // opacity의 값을 그대로 가져와서 동시에 시작되게 translateY설정함
